...
@interface ArderPortViewController ()<UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate>
...
static NSString *collCellIdentifer = @"ArderPortPhotoAvatCell";

@implementation ArderPortViewController
...
- (void)seekController {
    CityControllerViewController *arderContr = [[CityControllerViewController alloc] init];
    [self.navigationController pushViewController: arderContr animated:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.brand addTarget:self action:@selector(pushArderTransCon) forControlEvents:UIControlEventTouchUpInside];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITapGestureRecognizer *tapImageView = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapTransControll)];
...
- (void)tapTransControll {
    ArderTransViewController *arderTransView = [[ArderTransViewController alloc] init];
    [self.navigationController pushViewController:arderTransView animated:YES];
}
