...
- (void)viewDidLoad
{
    ...
    [rightBtn setFrame:CGRectMake(rect.size.width - 44, 20, 34, 34)];
    ...
    rootImageView = [[UIImageView alloc] initWithFrame:CGRectMake(40, 70, rect.size.width - 44 * 2, rect.size.height * 1 / 2 + 100)];
    ...
    scrollerView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, rect.size.height - 80, rect.size.width  - 10, 80)];
